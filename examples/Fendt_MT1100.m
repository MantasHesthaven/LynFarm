...
% -------------------------------------------------------------------------
dist_conf1 = 3000;  % Distance between the outer edges of the patches on
                    % each side of vehicle for configuration 1 [mm]

dist_conf2 = 0;  % Distance between the outer edges of the patches on
                    % each side of vehicle for configuration 2 [mm]

dist_conf12 = 0; % Center-Center distance between last patch in
                    % configuration 1 and first patch in configuration 2 [mm]

theta = 1.0829;     % Angular rotation to the X-axis line valid for all
                    % patches [Rad]
...
% For configuration 1
no_patches_conf1 = 34;   % No. of patches in configuration (must be even)
pitch_conf1 = 190;       % Pitch between patches [mm]
edge_offset_conf1 = 200; % Offset from outer edge [mm]
cent_offset_conf1 = 150; % Offset from centerline [mm]
L_conf1 = 300;           % Length of patch in this configuration [mm]
W_conf1 = 60;            % Width of patch in this configuration [mm]

% For configuration 2
no_patches_conf2 = 0;   % No. of patches in configuration (must be even)
pitch_conf2 = 0;       % Pitch between patches [mm]
edge_offset_conf2 = 0; % Offset from outer edge [mm]
cent_offset_conf2 = 0; % Offset from centerline [mm]
L_conf2 = 0;           % Length of patch in this configuration [mm]
W_conf2 = 0;            % Width of patch in this configuration [mm]
...
q_tot = [0.007 0.007 0.068 0.296 0.296 0.226 0.296 0.296 0.226 0.296 0.296...
         0.226 0.296 0.296 0.134 0.091 0.091 0.007 0.007 0.068 0.296 0.296...
         0.226 0.296 0.296 0.226 0.296 0.296 0.226 0.296 0.296 0.134 0.091...
     	 0.091 0.007 0.007 0.068 0.296 0.296 0.226 0.296 0.296 0.226 0.296...
     	 0.296 0.226 0.296 0.296 0.134 0.091 0.091 0.007 0.007 0.068 0.296...
     	 0.296 0.226 0.296 0.296 0.226 0.296 0.296 0.226 0.296 0.296 0.134...
     	 0.091 0.091];
